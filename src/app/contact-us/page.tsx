    ...
    <ParallaxProvider>
      ...
      <main className="min-h-screen relative overflow-hidden">
        ...
        <Parallax speed={-50} className="absolute inset-0 z-[-10]">
          <div className="bg-[url('/EggBG.png')] bg-repeat bg-cover w-full h-full"
            style={{
              backgroundSize: '180%',
        ...
        <div className="absolute top-0 left-0 w-full h-[50vh] flex items-center justify-center">
          <h1 className="font-kanit font-semibold text-[86px] text-[#005844]">ติดต่อเรา</h1>
        </div>
        ...
        <div className="w-full bg-[#F9F6F1] shadow-[rgba(0,0,12,0.2)_0px_0px_60px_0px] px-10 py-6 text-center relative z-10">
          <div className="font-kanit text-[48px] text-black">รายละเอียดการติดต่อ</div>
        </div>

        <div className="w-2/3 mx-auto mt-20 relative z-10" style={{ aspectRatio: '16 / 8' }}>
          <iframe
